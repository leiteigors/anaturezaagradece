...
<html>
        <table width='510' border='1' cellpadding='1' cellspacing='1' bgcolor='#CCCCCC'>
                <tr>
                        <td width='320'>Gratidão por querer melhorar o mundo  A Natureza Agradece 
Assim que o site estiver no ar, vocês serão avisados.

Vamos melhorar o mundo juntos...somos um!
<3
🍀
...
$arquivoResp = "<style type='text/css'>
  body {
  margin:0px;
  font-family:Verdane;
  font-size:12px;
...
<html>
        <table width='510' border='1' cellpadding='1' cellspacing='1' bgcolor='#CCCCCC'>
                <tr>
                        ...
                        Gratidão por querer melhorar o mundo  A Natureza Agradece 
Assim que o site estiver no ar, vocês serão avisados.
...
$emailRemetente = "mktplace@anaturezaagradece.com";
$emailDestino   = $email;
$assunto        = "A natureza agradece";

//Envio email

$emailRemetenteResp = "mktplace@anaturezaagradece.com";
$emailDestinoResp   = "mktplace@anaturezaagradece.com";
$assuntoResp        = "A natureza agradece";
...
$headersResp = 'MIME-Version: 1.0' . "\r\n";
$headersResp.= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
$headersResp.= 'From: $emailRemetente';



$enviarEmail = mail($emailDestino, $assunto, $arquivo, $headers);

$enviarEmailResp = mail($emailDestinoResp, $assuntoResp, $arquivoResp, $headersResp);
...
if ($emailDestino != null)
{
        if ($enviarEmail) 
        {
                ...
                $strcon = mysqli_connect('fdb17.atspace.me','2551446_anaturezaagradece','natagr123','2551446_anaturezaagradece') or die('Erro ao conectar ao banco de dados');
                $sql = "INSERT INTO Contato (email_contato) VALUES ('$emailDestino')";
                //$sql .= "('$email')";
        
                //$sql = "insert into contato (emailcontato) values (\"$HTTP_POST_VARS[$emailDestino]\")";
                ...
                echo'<div id="alertSucess" class="alert alert-success alert-dismissable" visible="false"> 
	...
	<!-- Note: You'll want to replace the form action and the input name with values from your own MailChimp account -->
		...
		<div class="social">
			<h4> Siga nossas atualizações: 
				...
				<a href="https://www.pinterest.pt/sabrinapfreitas/" target="_blank" > 
